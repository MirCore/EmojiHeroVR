...
//        Debug.Log("Unity v" + Application.unityVersion + ", " + "Oculus Utilities v" + OVRPlugin.wrapperVersion + ", " +
//                  "OVRPlugin v" + OVRPlugin.version + ", " + "SDK v" + OVRPlugin.nativeSDKVersion + ".");
...
//        Debug.LogFormat("Current display frequency {0}, available frequencies [{1}]", display.displayFrequency,
